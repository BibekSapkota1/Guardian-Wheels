...
function Home() {
  const boxes = [
    { imageUrl: parents, text: 'I am a parent', circle: 'bg-red-400', boxcolor: 'bg-red-300' },
    { imageUrl: '', text: 'I am a School', circle: 'bg-blue-400', boxcolor: 'bg-blue-300' },
    { imageUrl: '', text: 'I am a Bus Driver', circle: 'bg-red-600', boxcolor: 'bg-red-500' },
    { imageUrl: '', text: 'Request for tracking', circle: 'bg-blue-500', boxcolor: 'bg-blue-600' },
  ];
