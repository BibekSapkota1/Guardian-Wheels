  ...
  return (
    <div className="w-full flex bg-secondary rounded-lg my-5 items-center justify-between">
        <div className="w-5/12 mt-[-30px] justify-center items-center">
            <h1 className="text-xl text-center my-2 font-bold">{title}</h1>
            <div className={`bg-white shadow-inner border-b-2 mt-3 font-medium w-10/12 mx-auto rounded-2xl flex justify-center items-center ${color}`}>
                Learn More
            </div>
        </div>
